...
USERNAME = '18513998615'
PASSWORD = '1942b9cadf6b9de6192cf5f83fa280fc'
...
class DuSpider(object):
    ...
    def du_get(self, url):
        ...
        print("COOKIE------->", response.headers.get('Set-Cookie', '').split(';')[0])

        result = json.loads(response.read())
        print("loginToken------->", result.get('data', {}).get('loginInfo', {}).get('loginToken'))
